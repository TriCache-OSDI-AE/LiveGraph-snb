...
Graph::Graph(
    std::string block_path, std::string wal_path, std::string save_path, size_t max_block_size, vertex_t max_vertex_id)
    : graph(std::make_unique<impl::Graph>(block_path, wal_path, save_path, max_block_size, max_vertex_id))
{
}
